...
export const ProjectDashboard = ({project,tasks,activities,totalWorkspaceMembers,comments}:ProjectDashboardProps) => {
    ...
    <div className="flex flex-col gap-6 px-2 md:px-4 2xl:px-6 py-0">
       ...
       <Card className="p-4">
        <CircleProgress title="Task Completed" value={(tasks.completed/tasks.total)*100}
       ...
       <Card className="p-4">
        <CircleProgress title="In Progress" value={(tasks.inProgress/tasks.total)*100}
       ...
       <Card className="p-4">
        <CircleProgress title="Overdue" value={(tasks.overdue/tasks.total)*100}
       ...
       <Card className="p-4">
<CircleProgress title="Team Memebers" value={project.members.length}

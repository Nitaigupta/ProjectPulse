import { Task, User,File as PrismaFile } from "@/lib/generated/prisma";
    ...
    return <Card>
        ...
        <div>
            ...
            <div className="flex items-center gap-2">
                <ProjectAvatar name={task?.project.name} className="text-base text-muted-foreground"/>
                <p>
                    {
                        task?.project.name
                    }
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-medium">{format(task.dueDate,"MMM d ,yyyy")}
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    {
                        task?.attachments?.map((file)=>(
                            <div key={file.id} className="relative group cursor-pointer">
                                <Image src={file.type==="IMAGE"?file.url:"/pdf.png"} 
                                alt={"attachment"} 
                                width={80}
                                height={80}
        ...
        <a href={file.url} target="_blank" rel="noopener noreferrer">
            <span className="text-white text-sm">View</span>
                ...
                {task.attachments.length===0 &&( <div className="text-sm text-muted-foreground flex items-center h-20">

...
import { User,Comment } from "@/lib/generated/prisma/client";
...
import { postComment } from "@/app/actions/projects";
...
export const TaskComment=({taskId,comments}:TaskCommentProps)=>{
    ...
    return <Card>
        ...
        <div className="space-y-4">
            <Textarea placeholder="Add a comment..." className="min-h-[100px]" value={newComment} 
